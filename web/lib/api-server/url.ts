 ...
 *
 * Used by the Spotify connect route to remember which deployment the user
 * started on (e.g. a Vercel preview URL) so the callback can redirect them
 * back to the same origin instead of always landing on production.
 */
